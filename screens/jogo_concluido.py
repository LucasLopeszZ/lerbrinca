...
class JogoConcluidoScreen:
    ...
    def _draw_certificate(self):
        ...
        title = self.font_title.render("PARABENS!", True, LEGO_BLUE)
        ...
        for ox, oy in [(-4, 0), (4, 0), (0, -4), (0, 4), (-3, -3), (3, 3), (-3, 3), (3, -3)]:
            outline = pygame.transform.smoothscale(
                self.font_title.render("PARABENS!", True, LEGO_WHITE),
        ...
        self._draw_outlined_text("VOCE COMPLETOU", self.font_big, (self.W // 2, y + 254), LEGO_RED, width=2)
